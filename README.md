...
26-06-30    v1.6.4  优化删问答时删除图片逻辑的稳定性
...
1. 安装模块`git clone https://github.com/azmiao/YuiChyanBot`
2. Hoshino里配置好模块名'XQA'
3. 根据`requirements.txt`安装依赖
4. 更新代码直接使用`git pull`（注意：因为石山代码的配置写在`util.py`里了，改了配置的得先还原文件才能更新...）
